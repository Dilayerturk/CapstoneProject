...
namespace refactoradiyos_final.Views.TakipFormuEdit
{
    public class TakipFormuEditController : Controller
    {
        ...
        public ActionResult create(GeneralModel pModel)
        {
            ...
            return RedirectToAction("Index", "TakipFormuEdit",new { pId = pModel.patient_Info.IDNo});
        }
    }
}